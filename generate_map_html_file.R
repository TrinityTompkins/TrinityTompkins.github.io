...
my.path = '/Users/trinitytompkins/Desktop/lab7/index.html'
...
htmlwidgets::saveWidget(map, file = paste0(dirname(my.path), "/Users/trinitytompkins/Desktop/lab7/map.html"))
